...
export default class RestaurantsComponent extends Component {
    render() {
        return (
            ...
            <Container fluid>
                <Row md={3} className="pt-2">
                    {Array.from({ length: 9 }).map((_, idx) => (
                    <Col sm className="restaurant-card">
                        <Card>
                            <Card.Img variant="top" src={image}/>
                            <Card.Body>
                                <Card.Title bsPrefix={'restaurant-name'}>Casa Aladdin Restaurant <StarRating className="rating-comp"/></Card.Title>
                                <Card.Text bsPrefix={'restaurant-description'}>Cuisine marocaine, méditerranéenne, Végétariens bienvenus, Choix végétaliens, Halal, Plats sans gluten</Card.Text>
